...
import { ensureProfile, type EnsureProfileDb } from "@/lib/identity/clerk";
import { createServiceClient } from "@/lib/supabase/server";
import { narrowDb } from "@/lib/db-port";
import { resolveViewer, type Viewer } from "@/lib/identity/resolve-viewer";

export type { Viewer } from "@/lib/identity/resolve-viewer";
...
// lib/identity/resolve-viewer.ts instead of here — importing *this* file outside
...
// at the thin edge — resolveViewer() in lib/identity/resolve-viewer.ts is where the
